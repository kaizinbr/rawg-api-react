...
import { BiHomeCircle, BiSolidHomeCircle, BiSearch, BiSolidSearch, BiCart, BiSolidCart } from "react-icons/bi";
        ...
        <div className="homeBtn">
            <div className="arrow" style={{ transformOrigin: "50% 55%" }}>
                <button className="flex justify-center items-center" onClick={() => router.push('/')}>
                    {isHome ? (
                        <BiSolidHomeCircle className="h-6 w-6" />
                    ) : (
...
function SearchBtn() {
    ...
    return (
        <div className="homeBtn">
            <div className="arrow" style={{ transformOrigin: "50% 55%" }}>
                <button className="flex justify-center items-center" onClick={() => router.push('/cart')}>
                    {isSearch ? (
                        <BiSolidSearch className="h-6 w-6" />
                    ) : (
    ...
    return (
        ...
        >
            <div
                ...
                h-full px-6
                bg-neutral-700/80  border 
                min-[800px]:border-b-[1px] min-[800px]:border-neutral-600/20
                z-50 backdrop-blur-2xl
                min-[1536px]:mx-auto min-[1536px]:left-auto min-[1536px]:relative max-w-[1536px]
                absolute
                w-auto mx-0 my-0 rounded-full border-t-0 border-x-0 border-b-2 border-neutral-600/20
                shadow-2xl
                transition-all duration-300 ease-in-out
            `}
            >
